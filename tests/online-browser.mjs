...
try {
  ...
  assert.deepEqual(errors, []); console.log('Online browser regression passed: modes, registration, exclusive sessions, import/export, save retry, account stash, expiry/relogin, isolation and mobile.');
} catch (error) {
