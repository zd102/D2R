...
export class CampaignScreen {
  ...
  constructor(ui: UI) {
    ...
    ui.overlay.addEventListener('click', event => {
      ...
      if (button.dataset.enterLevel !== undefined) {
        ...
        if (index === hero.campaign.current && this.difficulty === hero.difficultyLevel && !hero.bossDefeated && index >= hero.campaign.cleared[this.difficulty]) ui.closePanel();
  ...
  reset() { this.act = this.ui.game.level.act; this.difficulty = this.ui.game.hero.difficultyLevel; }
  render() {
