...
export const skillById = Object.fromEntries(SKILLS.map(skill => [skill.id, skill])) as Record<SkillId, SkillDefinition>;
export const isSkill = (id: unknown): id is SkillId => typeof id === 'string' && Object.hasOwn(skillById, id);
export const isAura = (id: ActionId) => id !== 'attack' && skillById[id].tree !== 'combat';
...
export const emptySkills = () => Object.fromEntries(SKILLS.map(skill => [skill.id, 0])) as Record<SkillId, number>;
