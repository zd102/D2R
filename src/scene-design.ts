...
export type Landmark = 'den' | 'graveyard' | 'tristram' | 'tower' | 'catacombs' | 'sewers' | 'burial-hall' | 'hive' | 'orrery' | 'horadric-tomb' | 'spider-grove' | 'flayer-village' | 'bazaar' | 'travincal' | 'durance' | 'steppes' | 'despair' | 'hellforge' | 'chaos' | 'terror' | 'siege' | 'prison' | 'frozen-river' | 'ancients' | 'worldstone' | 'cow' | 'uberDiablo' | 'nihlathak' | 'pandemonium';
...
const drafts: Draft[] = [
  ...
  { landmark: 'hellforge', description: '熔岩长堤 · 铁链与巨砧', surface: 'basalt', edge: 'void', props: ['spike','crag','bones'], liquid: 'lava', atmosphere: 'ash', colors: { floor: 0x61524b, trim: 0xe39448 }, fog: .008, ambient: 1.3 },
  { landmark: 'chaos', description: '混沌教堂 · 十字翼廊与封印', surface: 'flagstone', edge: 'wall', props: ['pillar','spike','bones'], liquid: 'lava', atmosphere: 'ash', colors: { floor: 0x65534f, wall: 0x78615b, trim: 0xa68662 }, fog: .008, ambient: 1.3 },
  { landmark: 'terror', description: '混沌核心 · 五芒星祭场', surface: 'basalt', edge: 'void', props: ['spike','pillar','bones'], liquid: 'lava', atmosphere: 'ash', colors: { floor: 0x664744, trim: 0xe59750, liquid: 0xf66b27 }, fog: .009, ambient: 1.3 },
  ...
  { landmark: 'pandemonium', description: '六魔神祭坛 · 赤焰封印与地狱火炬', surface: 'basalt', edge: 'void', props: ['spike','obelisk','bones'], atmosphere: 'ash', liquid: 'lava', colors: { floor: 0x453037, wall: 0x60404c, trim: 0xe79b62, sky: 0x241420, liquid: 0xa62336, sun: 0xee7864, fill: 0x955077 }, fog: .013 },
];
